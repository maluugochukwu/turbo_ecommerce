...
<head>
	...
	<title>Store200</title>
	<link rel="stylesheet" href="css/parsley.css">
	<link rel="preconnect" href="http://fonts.gstatic.com/" crossorigin>
	<link rel="icon" href="img/logo_1.png" sizes="32x32" />
				...
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2" style="color:#000">Store200</h1>
							<p class="lead">
								Change Password
							</p>
						</div>
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center mb-5">
										<img src="img/logo_1.png" alt="Chris Wood" style="max-width:30%"  class="img-responsive" />
									</div>
									<form id="form1">
										...
										<div class="form-group">
											...
											<input class="form-control form-control-lg" type="password"  name="current_password" required placeholder="" />
										</div>
										<div class="form-group">
											<label><b>Enter new password</b></label>
											<input class="form-control form-control-lg" type="password"  name="password" required placeholder="" />
										</div>
										<div class="form-group">
											<label><b>Confirm Password</b></label>
											<input class="form-control form-control-lg" name="confirm_password" type="password" required placeholder="" />
											<small>
          </small>
										</div>
										<div>
										...
										<div class="text-center mt-3">
											<a href="javascript:sendLogin('form1')" class="btn btn-lg btn-info btn-block">Change Password</a>
										</div>
									</form>
								</div>
							</div>
