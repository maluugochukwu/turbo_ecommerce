...
?>
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Home Page List</h5>
        <h6 class="card-subtitle text-muted">The report contains about us page that have been setup in the system.</h6>
    </div>
    <div class="card-body">
       
        <!-- <a class="btn btn-primary" onclick="getModal('setup/home_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Home Settings</a> -->
