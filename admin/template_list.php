...
?>
   <div class="card">
    ...
    <div class="card-body">
      <a class="btn btn-info" onclick="getModal('setup/template_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Template</a>
