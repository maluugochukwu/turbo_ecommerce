...
<!--                <li class="nav-item"><a class="nav-link" href="#tab-2" data-toggle="tab" onclick="rreload()" role="tab">Other Image(s)</a></li>-->
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-1" role="tabpanel">
                   <div class="row">
                       <div class="col-sm-5">
                           <img class="img-thumbnail" src="<?php echo $product[0]['bg_image']; ?>" alt="">
                        </div>
                        <div class="col-sm-7">
...
<script>
    ...
    var coverImg = $("#extraupload").uploadFile({
                    ...
                    previewWidth: "100px",
                    maxFileCount:1,
                    dragDropStr:"<span><b>Drop Product Category Image here</b></span>",
                    multiple:false,
                    ...
                    dynamicFormData: function()
                    {
                        ...
                        var data = {op:'Product.setProductCategoryImage',id:$('#id').val(),operation:"<?php echo $operation; ?>" }
                        return data;
                    },
                        ...
                        if(data.response_code == 0)
                            {
                                ...
                                swal({
                                    ...
                                    getpage('product_category_list.php','page');
