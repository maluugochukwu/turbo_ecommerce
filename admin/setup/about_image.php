...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    $operation  = 'edit';
    $id         = $_REQUEST['id'];
    $sql        = "SELECT * FROM about_us WHERE id = '$id' LIMIT 1";
...
<!--                <li class="nav-item"><a class="nav-link" href="#tab-2" data-toggle="tab" onclick="rreload()" role="tab">Other Image(s)</a></li>-->
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-1" role="tabpanel">
                   <div class="row">
                       <div class="col-sm-5">
                           <img class="img-thumbnail" src="<?php echo $product[0]['value']; ?>" alt="">
                        </div>
                        <div class="col-sm-7">
...
<script>
    ...
    var coverImg = $("#extraupload").uploadFile({
                    ...
                    dynamicFormData: function()
                    {
                        ...
                        var data = {op:'About.setAboutImage',id:$('#id').val(),operation:"<?php echo $operation; ?>" }
                        return data;
                    },
