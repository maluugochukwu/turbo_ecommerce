...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    $operation = 'edit';
    $id = $_REQUEST['id'];
    $sql_category = "SELECT * FROM blog_category WHERE id = '$id' LIMIT 1";
    $category = $dbobject->db_query($sql_category);
}else
{
    $operation = 'new';
}
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Blog Category Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Blog.saveBlogCategory">
       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" name="name"  value="<?php echo $category[0]['name']; ?>"  class="form-control" />
                </div>
           </div>
       </div>
            ...
            if(re.response_code == 0)
                {
                    ...
                    getpage('blog_category_list.php','page');
