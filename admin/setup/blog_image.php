...
<!--                <li class="nav-item"><a class="nav-link" href="#tab-2" data-toggle="tab" onclick="rreload()" role="tab">Other Image(s)</a></li>-->
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-1" role="tabpanel">
                   <div class="row">
                       <div class="col-sm-5"><p>Name: <?php echo $product[0]['name']; ?></p><img class="img-thumbnail" src="<?php echo $product[0]['picture']; ?>" alt=""></div>
...
<script>
    ...
    var coverImg = $("#extraupload").uploadFile({
                    ...
                    dynamicFormData: function()
                    {
                        ...
                        var data = {op:'Blog.updateDressImage',id:$('#id').val(), image_location:$('#image_path').val(),u_type:'primary' }
                        return data;
                    },
