...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold"><?php echo $product[0]['name']; ?> Mascot Image</h4>
    ...
    <form id="form1" onsubmit="return false">
       ...
       <div class="tab">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item"><a class="nav-link active" href="#tab-1" data-toggle="tab" role="tab">Mascot Image</a></li>
<!--                <li class="nav-item"><a class="nav-link" href="#tab-2" data-toggle="tab" onclick="rreload()" role="tab">Other Image(s)</a></li>-->
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab-1" role="tabpanel">
                   <div class="row">
                       <div class="col-sm-5">
                           <img class="img-thumbnail" src="<?php echo $product[0]['mascot']; ?>" alt="">
                        </div>
                        <div class="col-sm-7">
...
<script>
    ...
    var coverImg = $("#extraupload").uploadFile({
                    ...
                    previewWidth: "100px",
                    maxFileCount:1,
                    dragDropStr:"<span><b>Drop Product Mascot Image here</b></span>",
                    multiple:false,
                    ...
                    dynamicFormData: function()
                    {
                        ...
                        var data = {op:'Product.setMascotImage',id:$('#id').val(),operation:"<?php echo $operation; ?>" }
                        return data;
                    },
