...
//
$id = $_REQUEST['id'];
$sql = "SELECT id,name FROM job_industry WHERE id <> '$id'";
$ji = $dbobject->db_query($sql);
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Transfer Merchant Category</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Merchant.transferMerchantCategory">
       <input type="hidden" name="operation" value="<?php echo $operation; ?>">
       <input type="hidden" name="ji_name_old" value="<?php echo $id; ?>">
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Category Name</label>
                    <select name="ji_name" id="" class="form-control">
                        <?php
                            foreach($ji as $row)
                            {
