...
$social_media = $dbobject->db_query($sql);

if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    $operation = 'edit';
    $id = $_REQUEST['id'];
    $sql_category = "SELECT * FROM social_media_address WHERE id = '$id' LIMIT 1";
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Social Media Address Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="SocialMediaAddress.saveSocialMediaAddress">
...
<!--                     <input type="text" autocomplete="off" name="name"  value="<?php //echo $cat[0]['name']; ?>"  class="form-control" /> -->
                    <select name="name" id="" class="form-control">
                        ...
                        {
                            $selected = ($row['id']  == $cat[0]['name'])?"dselected":"";
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Media Address</label>
                    <input type="text" name="icon" class="form-control" value="<?php echo $cat[0]['value']; ?>" placeholder="">
                </div>
           </div>
