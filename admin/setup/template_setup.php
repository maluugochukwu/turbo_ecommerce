...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    $operation = 'edit';
    $id = $_REQUEST['id'];
    $sql_category = "SELECT * FROM templates WHERE id = '$id' LIMIT 1";
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Template Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Templates.saveTemplate">
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Title</label>
                     <input type="text" autocomplete="off" name="title" id="title"  value="<?php echo $cat[0]['title']; ?>"  class="form-control" /> 
...
<script>
   var coverImg = $("#extraupload").uploadFile({url:"utilities.php",
                    fileName:"upfile",
                    showPreview:true,
                    previewHeight: "100px",
                    previewWidth: "100px",
                    maxFileCount:1,
                    dragDropStr:"<span><b>Drop Template File here</b></span>",
                    multiple:false,
