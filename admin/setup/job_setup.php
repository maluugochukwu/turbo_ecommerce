...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    $operation = 'edit';
    $id = $_REQUEST['id'];
    $sql_category = "SELECT * FROM job_posting WHERE id = '$id' LIMIT 1";
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Job Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Jobs.saveJob">
       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <!-- <input type="text" autocomplete="off" name="company_name"  value="<?php// echo $cat[0]['company_name']; ?>"  class="form-control" /> -->
                    <select name="company_name" id="company_name" class="form-control">
                        <option value="">:: SELECT AN OPTION ::</option>
                        <?php
                            foreach($company as $row)
                            {
                                $selected = ($row['id'] == $cat[0]['company_name'])?'selected':"";
           ...
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" name="job_title" class="form-control" value="<?php echo $cat[0]['job_title']; ?>" placeholder="">
                </div>
           </div>
       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <select name="location" onchange="display_icon(this.value)" id="icon" class="form-control">
                       <option value="">::PLEASE SELECT A STATE::</option>
                        <?php
                            foreach($states as $row)
                            {
                                $selected = ($cat[0]['location'] == $row['state_code'])?"selected":"";
                    ...
                    <select name="category" id="category" class="form-control">
                       <option value="">::PLEASE SELECT A CATEGORY::</option>
                        <?php
                            ...
                            {
                                $selected = ($cat[0]['category'] == $row['id'])?"selected":"";
       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" name="closing_date" id="start_date" value="<?php echo $cat[0]['closing_date']; ?>"  class="form-control" />
                </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Job Responsibilities</label>
                    <input type="text" name="responsibilities" class="form-control" value="<?php echo $cat[0]['responsibilities']; ?>" placeholder="">
                </div>
           </div>
       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" name="requirement"  value="<?php echo $cat[0]['requirement']; ?>"  class="form-control" />
                </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">How to Apply</label>
                    <input type="text" name="how_to_apply" class="form-control" value="<?php echo $cat[0]['how_to_apply']; ?>" placeholder="">
                </div>
           </div>
       ...
       <div class="row">
           <div class="col-sm-12">
               <div class="form-group">
                    ...
                    <!-- <input type="text" autocomplete="off" name="requirement"  value="<?php echo $cat[0]['requirement']; ?>"  class="form-control" /> -->
                    <textarea name="description" class="form-control" id="description" cols="30" rows="10"><?php echo $cat[0]['description']; ?></textarea>
                </div>
           </div>
           </div>
