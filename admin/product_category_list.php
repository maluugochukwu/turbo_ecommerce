...
?>
   <div class="card">
    <div class="card-header">
        ...
        <h6 class="card-subtitle text-muted">The report contains product category that have been setup in the system.</h6>
    </div>
    <div class="card-body">
        
        <a class="btn btn-info" onclick="getModal('setup/product_category_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Product Category</a>
...
<script>
  var table;
  var editor;
  var op = "Product.productCategoryList";
